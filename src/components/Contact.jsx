      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            Entre em contato comigo para colaboração
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Entre em contato hoje mesmo para discutir as necessidades do seu
            projeto e comece a criar algo incrível!
          </p>
        ...
        <form
          action="https://getform.io/f/bolgxeda"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                name="email"
                autoComplete="email"
                placeholder="rafa123839@gmail.com"
              />
            </div>
          </div>
